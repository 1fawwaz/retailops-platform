...
def _to_read_model(product: Product) -> ProductRead:
    return ProductRead(
        ...
        gst_percent=float(product.gst_percent) if product.gst_percent is not None else None,
        hsn_code=product.hsn_code,
        shelf_life_days=product.shelf_life_days,
        weight_grams=float(product.weight_grams) if product.weight_grams is not None else None,
        reorder_quantity=product.reorder_quantity,
        eoq=product.eoq,
        abc_class=product.abc_class,
        xyz_class=product.xyz_class,
        behavior_pattern=product.behavior_pattern,
